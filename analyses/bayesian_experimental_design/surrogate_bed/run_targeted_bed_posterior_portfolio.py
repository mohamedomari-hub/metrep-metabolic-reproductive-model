...
DEFAULT_ENRICHED_FORMATTED = Path(__file__).resolve().parent / "phd_bed_bank_5pct_50k_glucagon_smc_enriched"
DEFAULT_GLOBAL = ROOT / "analyses/global_sensitivity/outputs_smc_enriched_5pct_glucagon"
DEFAULT_UNCERTAINTY = ROOT / "analyses/uncertainty/outputs_smc_enriched_5pct_glucagon"
