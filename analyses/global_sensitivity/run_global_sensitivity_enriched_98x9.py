...
sys.path.insert(0, str(ROOT / "analyses/global_sensitivity"))

from run_global_sensitivity import (
...
FORMATTED_ENRICHED = ROOT / "analyses/bayesian_experimental_design/surrogate_bed/phd_bed_bank_5pct_50k_glucagon_smc_enriched"
